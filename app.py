...
def summary(model_name, temperature, top_p):
    ...
    if uploaded_file is not None:
        ...
        if gen_sum:
            ...
            msg_initiate6 = agent.invoke({"input": "Analyze factor from additional information, that might affect significant monthly changes on each store, and in which month? If you come up with python code to do such analysis, execute the code and let me know the result"})
